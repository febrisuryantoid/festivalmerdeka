          ...
          <div className="relative max-w-5xl mx-auto py-8">
            ...
            <div className="space-y-10 sm:space-y-16">
              {[
                ...
                {
                  title: "Turnamen Free Fire (FF)",
                  date: "14 Agustus 2026 (Pukul 20.00 WIB)",
                  icon: Gamepad2,
                  badge: "Free Fire",
                  desc: "Seluruh rangkaian pertandingan Free Fire mulai dari babak penyisihan hingga Grand Final dilaksanakan pada tanggal 14 Agustus Pukul 20.00 WIB berlokasi di Kp. Batu Karut RT/RW 08/04, Desa Padasuka, Kec. Baros, Kab. Serang, Banten.",
                },
                {
                  title: "Turnamen Mobile Legends (MLBB)",
                  date: "15 Agustus 2026 (Pukul 20.00 WIB)",
                  icon: Trophy,
                  badge: "Mobile Legends",
                  desc: "Seluruh rangkaian pertandingan Mobile Legends mulai dari babak penyisihan hingga Grand Final dilaksanakan pada tanggal 15 Agustus Pukul 20.00 WIB berlokasi di Kp. Batu Karut RT/RW 08/04, Desa Padasuka, Kec. Baros, Kab. Serang, Banten.",
                },
                {
                  title: "Turnamen PS4 Pro FC26",
