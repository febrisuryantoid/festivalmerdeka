              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-100/80 border-b border-slate-200 text-xs font-extrabold text-slate-700 uppercase tracking-wider">
                    ...
                    <th className="py-3.5 px-4 text-right">Tanggal Terverifikasi</th>
                  </tr>
                </thead>
                  ...
                  <AnimatePresence mode="popLayout">
                    {filtered.map((item, i) => (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-4 text-right text-xs sm:text-sm text-slate-600 font-medium whitespace-nowrap">
                          <span className="inline-flex items-center justify-end gap-1.5 text-slate-600 bg-slate-100 px-2.5 py-1 rounded-lg">
